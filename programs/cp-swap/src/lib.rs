...
solana_security_txt::security_txt! {
    ...
    contacts: "email:security@kedolik.io",
    policy: "https://kedolik.io/security",
    source_code: "https://github.com/kedolik/kedolik-cp-swap",
    preferred_languages: "en",
    auditors: "Based on audited Raydium code: https://github.com/raydium-io/raydium-docs/blob/master/audit/MadShield%20Q1%202024/raydium-cp-swap-v-1.0.0.pdf"
}
...
pub mod kedolik_cp_swap {
    ...
    pub fn create_amm_config(
        ...
        assert!(fee_token_discount_rate <= 10000); // Max 100% discount
