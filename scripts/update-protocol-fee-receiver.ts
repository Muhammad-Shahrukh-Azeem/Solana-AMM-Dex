...
async function updateProtocolFeeReceiver() {
  const args = process.argv.slice(2);
  
  if (args.length === 0) {
    console.log('\n❌ Usage: npx ts-node scripts/update-protocol-fee-receiver.ts <NEW_RECEIVER_ADDRESS>\n');
    console.log('Example:');
    console.log('  npx ts-node scripts/update-protocol-fee-receiver.ts 67D6TM8PTsuv8nU5PnUP3dV6j8kW3rmTD9KNufcEUPCa\n');
    process.exit(1);
  }
  ...
  console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('🔧 UPDATE PROTOCOL FEE RECEIVER');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
  ...
  console.log(`  Protocol Fee Receiver:      ${newReceiver.toString()} ← UPDATING\n`);
  ...
  try {
    ...
    // Call updateAmmConfig with param=9 (protocol_fee_receiver)
    const tx = await (signingProgram.methods as any)
      .updateAmmConfig(
        9,           // param = 9 → update protocol_fee_receiver
    ...
    if (updatedConfig.protocolFeeReceiver.toString() === newReceiver.toString()) {
      console.log('✅ Protocol fee receiver updated successfully!');
      console.log('   From now on, only this wallet can claim protocol fees:');
...
updateProtocolFeeReceiver().catch(console.error);
